...
export const builtInVariablesHelp = [
    {
        name: 'player',
        content: `The player object you can read from (position, health, knockback movement, etc). Local and party members use the same shape: equipment values live on [color=#ffa500]player.stats[/color] (e.g. [color=#ffa500]player.stats.critical[/color], [color=#ffa500]player.stats.block[/color], [color=#ffa500]player.stats.knockback[/color] knockback [i]resistance[/i], not knockbackTime, [color=#ffa500]player.stats.parry[/color], [color=#ffa500]player.stats.MpRegen[/color], [color=#ffa500]player.stats.recovery[/color], [color=#ffa500]player.stats.reload[/color], [color=#ffa500]player.stats.maxHp[/color], [color=#ffa500]player.stats.maxMp[/color], plus destroyer / weakspot / pierce / medic / hitpointSize). Current [color=#ffa500]hp[/color], [color=#ffa500]mp[/color], [color=#ffa500]maxHp[/color], and [color=#ffa500]maxMp[/color] are also on [color=#ffa500]player[/color] for combat UI. After an unblocked hit, [color=#ffa500]parryIFrameRemaining[/color] counts down; while above 0, enemy bullets pass through ([i]two frames[/i] per Parry stat point). Do not assign [color=#ffa500]player.stats[/color] in scripts — sync overwrites it. [color=#ffa500]Game.syncPlayerStatsFromInventoryIfPossible()[/color] refreshes the local player after inventory changes.

[b]Properties:[/b] [color=#ffa500]x[/color], [color=#ffa500]y[/color], [color=#ffa500]hp[/color], [color=#ffa500]mp[/color], [color=#ffa500]maxHp[/color], [color=#ffa500]maxMp[/color], [color=#ffa500]stats[/color], [color=#ffa500]knockbackTime[/color], [color=#ffa500]knockbackPower[/color], [color=#ffa500]knockbackDirection[/color], [color=#ffa500]parryIFrameRemaining[/color].`
    },
    {
        name: 'bulletData',
